...
modules = [
    ...
    'pyfr.solvers.moving_grid',
    'pyfr.solvers.moving_grid.kernels',
    'pyfr.solvers.overset',
    'pyfr.solvers.overset.kernels',
    'pyfr.writers'
]
...
package_data = {
    ...
    'pyfr.solvers.moving_grid.kernels': ['*.mako'],
    'pyfr.solvers.overset.kernels': ['*.mako'],
    'pyfr.tests': ['*.npz']
}
